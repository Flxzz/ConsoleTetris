...
void PrintColor(short x, short y, Color color)
{
	...
	{
	case WHITE:
		PrintString(L"白色  ", x, y, color);
		break;
	case RED:
		PrintString(L"红色  ", x, y, color);
		break;
	case GREEN:
		PrintString(L"绿色  ", x, y, color);
		break;
	case BLUE:
		PrintString(L"蓝色  ", x, y, color);
		break;
	case YELLOW:
		PrintString(L"黄色  ", x, y, color);
		break;
	case CYAN:
		PrintString(L"蓝绿色", x, y, color);
		break;
	case PURPLE:
		PrintString(L"紫色  ", x, y, color);
		break;
	case GRAY:
		PrintString(L"灰色  ", x, y, color);
		break;
	default:
		break;
	}
